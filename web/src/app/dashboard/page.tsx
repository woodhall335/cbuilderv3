  ...
  return (
    <main className="mx-auto max-w-6xl space-y-8 px-4 py-16">
      <header className="space-y-3">
        <h1 className="text-3xl font-semibold text-neutral-900">Your dashboard</h1>
        <p className="text-neutral-600">
          Drafts you save from the wizard appear here. They are stored locally in your browser so you stay in control of your data.
        </p>
      ...
      {documents.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-neutral-300 px-6 py-16 text-center">
          <p className="text-sm text-neutral-600">
            You have not saved any documents yet. Generate a draft in the wizard and click “Save to dashboard”.
          </p>
        </div>
      ) : (
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-neutral-500">
                    Saved {new Date(document.generatedAt).toLocaleString()}
                  </p>
                </div>
                <button
                  type="button"
